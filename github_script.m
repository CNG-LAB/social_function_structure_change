...
%     Sex, IDs, timepoint, quality control, presence of timepoint.
end
...
for f2 = 1
    ...
    for F2 = 1
        ...
        %group ssize
        size(find(strcmp(groupN(keep),'Presence')))
        size(intersect(find(strcmp(groupN(keep),'Affect')),find(~strcmp(group4(keep),'Group3'))))
        size(find(strcmp(groupN(keep),'Perspective')))
        size(find(strcmp(groupN(keep),'Control1')))
        size(intersect(find(strcmp(groupN(keep),'Affect')),find(strcmp(group4(keep),'Group3'))))
        ...
        exportfigbo(f,[RPATH 'F2.Presence.t.png'],'png', 10)    
        
        csvwrite([RPATH 'F2.Presence.t.csv'],[slm.t])
        ...
        BoSurfStatColLim([-4 4])
        colormap(flipud(cbrewer('div','RdBu',11)))
        exportfigbo(f,[RPATH 'F2.Perspective.t.png'],'png', 10)
        
        csvwrite([RPATH 'F2.Perspective.t.csv'],[slm.t'])
        ...
        BoSurfStatColLim([-4 4])
        colormap(flipud(cbrewer('div','RdBu',11)))
        exportfigbo(f,[RPATH 'F2.Affect.t.png'],'png', 10)
        
        csvwrite([RPATH 'F2.Affect.t.csv'],[slm.t'])
        ...
        BoSurfStatColLim([-4 4])
        colormap(flipud(cbrewer('div','RdBu',11)))
        exportfigbo(f,[RPATH 'F2.Control.t.png'],'png', 10)
        
        csvwrite([RPATH 'F2.Control.t.csv'],[slm.t'])
        ...
        for pre_per = 1
            ...
            p        = 2*(1 - tcdf(abs(slm.t),slm.df))
            csvwrite([RPATH 'F2.Presence_Perspective.t.csv'],[slm.t'])
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'F2.Perspective-Presence.fdr.png'],'png', 10)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'F2.Perspective-Presence.trend.png'],'png', 10)
        ...
        for pre_aff = 1
            ...
            p        = 2*(1 - tcdf(abs(slm.t),slm.df))
            csvwrite([RPATH 'F2.Presence_Affect.t.csv'],[slm.t'])
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'F2.Presence_affect.fdr.png'],'png', 10)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'F2.Presence_affect.trend.png'],'png', 10)
        ...
        for per_aff = 1
            ...
            p        = 2*(1 - tcdf(abs(slm.t),slm.df))
            csvwrite([RPATH 'F2.Perspective_Affect.t.csv'],[slm.t'])
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'F2.perspective_affect.fdr.png'],'png', 10)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'F2.perspective_affect.trend.png'],'png', 10)
        ...
        for i = 1:5
            ...
            neurod(i,1) = (2*(slm.t))./sqrt(slm.df)
        end
        for i = 1:5
            slm      = SurfStatLinMod(mean(Xn(keep,maps_ns(:,i)>0),2),M);
            slm      = SurfStatT(slm,(GN.Presence-GN.Affect))
            ...
            neurod(i,2) = (2*(slm.t))./sqrt(slm.df)
        end
        for i = 1:5
            slm      = SurfStatLinMod(mean(Xn(keep,maps_ns(:,i)>0),2),M);
            slm      = SurfStatT(slm,(GN.Perspective-GN.Affect))
            ...
            neurod(i,3) = (2*(slm.t))./sqrt(slm.df)
        end
        
       csvwrite([RPATH 'Table4.csv'],[neuros(:,1),neurop(:,1),neurod(:,1),...
           neuros(:,2),neurop(:,2),neurod(:,2),...
           neuros(:,3),neurop(:,3),neurod(:,3)])
        ...
        %F2C and Supplement F1
        for k = 1:5
            for run_plot =1
                bh = mean(GGG400(:,maps_ns(:,k)>0),2);
                keep = find(keeptmp>0);
                Ck = bh;
                gk = group4(keep);
                ik = id(keep);
            ...
            exportfigbo(f,[RPATH 'SF1.meanGGG.network.',num2str(k) ,'.png'],'png', 10)
        end
...
for f2_subs = 1
    ...
    for ST1_4 = 1
        ...
        %group ssize
        size(find(strcmp(groupN(keep),'Presence')))
        size(find(strcmp(groupN(keep),'Affect')))
        size(find(strcmp(groupN(keep),'Perspective')))
        size(find(strcmp(groupN(keep),'Control1')))
          ...
          for key_descriptives = 1
           ...
           keep_presence = (find(strcmp(groupN(keep),'Presence')))
           keep_affect = (find(strcmp(groupN(keep),'Affect')))
           keep_affect_exclT3 = intersect(find(strcmp(groupN(keep),'Affect')),find(~strcmp(group4(keep),'Group3')))
           keep_perspective = (find(strcmp(groupN(keep),'Perspective')))
           keep_control   = (find(strcmp(groupN(keep),'Control1')))
           ...
           for i = 1:5
               x = mean(Xn(keep(keep_affect_exclT3),maps_ns(:,i)>0),2);
               meansdata(i,5) = mean(x);
               stddata(i,5) = std(x);
               SEM = std(x)/sqrt(length(x)); % Standard Error
               ts = tinv([0.025  0.975],length(x)-1);      % T-Score
               cidata(i,5,:) = mean(x) + ts*SEM;
           end
           
           csvwrite([RPATH 'ST1.GGGraws_network_presence.csv'],[meansdata(:,1),stddata(:,1),cidata(:,1,1),cidata(:,1,2)])
           csvwrite([RPATH 'ST2.GGGraws_network_affect.csv'],[meansdata(:,2),stddata(:,2),cidata(:,2,1),cidata(:,2,2)])
           csvwrite([RPATH 'ST3.GGGraws_network_perspective.csv'],[meansdata(:,3),stddata(:,3),cidata(:,3,1),cidata(:,3,2)])
           csvwrite([RPATH 'ST4.GGGraws_network_control.csv'],[meansdata(:,4),stddata(:,4),cidata(:,4,1),cidata(:,4,2)])
           csvwrite([RPATH 'ST2b.GGGraws_network_affect_exclTC3.csv'],[meansdata(:,5),stddata(:,5),cidata(:,5,1),cidata(:,5,2)])
    ...
    for ST5 = 1
        ...
        for i = 1:5
         ...
         csvwrite([RPATH 'ST5.csv'],[neuros(:,1),neurop(:,1),...
           neuros(:,2),neurop(:,2),...
           neuros(:,3),neurop(:,3)])
    ...
    for ST6 = 1
        ...
        csvwrite([RPATH 'ST6.csv'],[neuros(:,1),neurop(:,1),...
           neuros(:,2),neurop(:,2),...
           neuros(:,3),neurop(:,3)])
    ...
    for ST7 = 1
        ...
        csvwrite([RPATH 'ST7.csv'],[neuros(:,1),neurop(:,1),...
           neuros(:,2),neurop(:,2),...
           neuros(:,3),neurop(:,3)])
    end
    ...
    for ST8 = 1
        ...
        M        = 1 + A + S + G4 + random(Sub) + I;
 
        Xn = ggg_400_last;
        neuros = zeros(5,3);
        for i = 1:5
            slm      = SurfStatLinMod(mean(Xn(keep,maps_ns(:,i)>0),2),M);
            slm      = SurfStatT(slm,(G4.Group_1-G4.Control))
            neuros(i,1) = slm.t;
            neurop(i,1) = 2*(1 - tcdf(abs(slm.t),slm.df));
        end
        for i = 1:5
            slm      = SurfStatLinMod(mean(Xn(keep,maps_ns(:,i)>0),2),M);
            slm      = SurfStatT(slm,(G4.Group_2-G4.Control))
            neuros(i,2) = slm.t;
            neurop(i,2) = 2*(1 - tcdf(abs(slm.t),slm.df));
        end
        for i = 1:5
            slm      = SurfStatLinMod(mean(Xn(keep,maps_ns(:,i)>0),2),M);
            slm      = SurfStatT(slm,(G4.Group3-G4.Control))
            neuros(i,3) = slm.t;
            neurop(i,3) = 2*(1 - tcdf(abs(slm.t),slm.df));
        end
        for i = 1:5
            slm      = SurfStatLinMod(mean(Xn(keep,maps_ns(:,i)>0),2),M);
            slm      = SurfStatT(slm,(G4.Group_1-G4.Group3))
            neuros(i,4) = slm.t;
            neurop(i,4) = 2*(1 - tcdf(abs(slm.t),slm.df));
        end
        for i = 1:5
            slm      = SurfStatLinMod(mean(Xn(keep,maps_ns(:,i)>0),2),M);
            slm      = SurfStatT(slm,(G4.Group_2-G4.Group3))
            neuros(i,5) = slm.t;
            neurop(i,5) = 2*(1 - tcdf(abs(slm.t),slm.df));
        end
        
       csvwrite([RPATH 'ST8.csv'],[neuros(:,1),neurop(:,1),...
           neuros(:,2),neurop(:,2),neuros(:,3),neurop(:,3),...
           neuros(:,4),neurop(:,4),neuros(:,5),neurop(:,5)])
    end
    ...
    for ST9 = 1
       ...
       csvwrite([RPATH 'ST9.csv'],[neuros(:,1),neurop(:,1),...
           neuros(:,2),neurop(:,2),neuros(:,3),neurop(:,3)])
    end

    for ST10_ST12_SF2_SF4 = 1
        Xn            = squeeze(layer_400_last(:,1,:));
        Xn(isnan(Xn)) = 0;
        Xn(isinf(Xn)) = 0;
        Xm            = ggg_400_last;
        ...
        for gradient1  =1
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF2.Presence-Perspective.G1.fdr.png'],'png', 10)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF2.Presence-Perspective.G1.p.png'],'png', 10)
        ...
        for gradient2  =1
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF3.Presence-Perspective.G2.fdr.png'],'png', 10)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF3.Presence-Perspective.G2.p.png'],'png', 10)
        ...
        for gradient3  =1
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF4.Presence-Perspective.G3.fdr.png'],'png', 10)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF4.Presence-Perspective.G3.p.png'],'png', 10)
        ...
        for gradient1  =1
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF2.Presence-Affect.G1.fdr.png'],'png', 10)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF2.Presence-Affect.G1.p.png'],'png', 10)
        ...
        for gradient2  =1
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF3.Presence-Affect.G2.fdr.png'],'png', 10)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF3.Presence-Affect.G2.p.png'],'png', 10)
        ...
        for gradient3  =1
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF4.Presence-Affect.G3.fdr.png'],'png', 10)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF4.Presence-Affect.G3.p.png'],'png', 10)
        ...
        for gradient1  =1
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF2.Perspective-Affect.G1.fdr.png'],'png', 10)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF2.Perspective-Affect.G1.p.png'],'png', 10)
        ...
        for gradient2  =1
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF3.Perspective-Affect.G2.fdr.png'],'png', 10)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF3.Perspective-Affect.G2.p.png'],'png', 10)
        end
        for gradient3  =1
            slm      = SurfStatLinMod(g3_400_last(keep,:),M);
            slm      = SurfStatT(slm,(GN.Perspective-GN.Affect))
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF4.Perspective-Affect.G3.fdr.png'],'png', 10)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF4.Perspective-Affect.G3.p.png'],'png', 10)
        end
        ...
        for PrP =1
            ...
            csvwrite([RPATH 'ST10.csv'],[neuros(:,1),neurop(:,1),neuros(:,2),neurop(:,2),neuros(:,3),neurop(:,3)])
        ...
        for PrA =1
            ...
            csvwrite([RPATH 'ST11.csv'],[neuros(:,1),neurop(:,1),neuros(:,2),neurop(:,2),neuros(:,3),neurop(:,3)])
        ...
        for PeA =1
            ...
            csvwrite([RPATH 'ST12.csv'],[neuros(:,1),neurop(:,1),neuros(:,2),neurop(:,2),neuros(:,3),neurop(:,3)])
    ...
    for ST13 = 1
       ...
       csvwrite([RPATH 'ST13.csv'],[neuros(:,1),neurop(:,1),neuros(:,2),neurop(:,2),neuros(:,3),neurop(:,3)])
    ...
    for ST14 = 1
        ...
        keep1   = union(keep1,find(strcmp(groupN,'Control1')))
        keep2   = intersect(find(abs(mean(Xn,2)) <666), find(sum(Xn,2)~=0));
        keep3   = intersect(find(~strcmp(group4,'Group3')),find(tpnum>2));
        keep4   = intersect(find(abs(mean(Xm,2)) <666), find(sum(Xm,2)~=0));
        keep    = mintersect(keep1, keep2,keep3,keep4);
        ...
        for i  = 1
            ...
            csvwrite([RPATH 'ST14.csv'],[neuros(:,1),neurop(:,1)])
...
for f3 = 1
    ...
    for F3a = 1
        ...
        exportfigbo(f,[RPATH 'F3.t1q.png'],'png', 10)    
    end
    ...
    for F3b = 1
        ...
        for func_in_t1q = 1
            ...
            for k=1:12
                ...
                t_dept(k,1) = slm.t;
                d_dept(k,1) = (2*(slm.t))./sqrt(slm.df)
                slm      = SurfStatLinMod(mean(Xx(keep,f1_h>0),2),M);
                slm      = SurfStatT(slm,(GN.Presence-GN.Affect))
                slm2 = slm.t;
            ...
            f=figure,
            imagesc(t_dept.*[fdr_bh(p_dept(:,1)),fdr_bh(p_dept(:,2)),fdr_bh(p_dept(:,3))],[-4 4])
            colormap(flipud(cbrewer('div','RdBu',99)))
            colorbar
            exportfigbo(f,[RPATH 'F3Aii.layer2func.super.stat.png'],'png', 10)
            
            f=figure,
            imagesc(t_dept.*[fdr_bh(p_dept(:,1),0.1),fdr_bh(p_dept(:,2),0.1),fdr_bh(p_dept(:,3)],[-4 4])
            colormap(flipud(cbrewer('div','RdBu',99)))
            exportfigbo(f,[RPATH 'F3Aii.layer2func.super.raw.png'],'png', 10)
        ...
        for F3b = 1
            ...
            fdrtrend = (fdr_bh(p_dept,0.1));
            
            for i = 1:5
                f=figure,
                imagesc(t_dept(:,:,i).*fdrcor(:,:,i),[-5 5])
                colormap(flipud(cbrewer('div','RdBu',99)))
                %exportfigbo(f,[RPATH 'F3B.layer-network', num2str(i) ,'.png'],'png', 10)
                
                f=figure,
                imagesc(t_dept(:,:,i).*fdrtrend(:,:,i),[-5 5])
                colormap(flipud(cbrewer('div','RdBu',99)))
                %exportfigbo(f,[RPATH 'F3B.layer-network', num2str(i) ,'.raw.png'],'png', 10)
            end
        ...
        for F3c = 1
            for change_presence = 1
                ...
                csvwrite([RPATH 'F3c.Presence.maps.csv'],[r_original_thick_1,...
                    prctile_rank_thick_1,r_original_thick_2,...
                    prctile_rank_thick_2,r_original_thick_3,...
                    prctile_rank_thick_3,r_original_thick_4,...
                    prctile_rank_thick_4])
            ...
            for change_affect = 1
                ...
                for gradient_diff = 1
                    ...
                    csvwrite([RPATH 'F3c.Affect.maps.csv'],[r_original_thick_1,...
                    prctile_rank_thick_1,r_original_thick_2,...
                    prctile_rank_thick_2,r_original_thick_3,...
                    prctile_rank_thick_3,r_original_thick_4,...
                    prctile_rank_thick_4])
            ...
            for change_perspective = 1
                ...
                keep2b   = intersect(find(Xm(:,1) >-666), find(sum(Xm,2)~=0));
                keep5   = find(tpnum>0);
                keep    = mintersect(keep1,keep2,keep2b,keep5);
                ...
                for gradient_diff = 1
                    ...
                    csvwrite([RPATH 'F3c.Perspective.maps.csv'],[r_original_thick_1,...
                    prctile_rank_thick_1,r_original_thick_2,...
                    prctile_rank_thick_2,r_original_thick_3,...
                    prctile_rank_thick_3,r_original_thick_4,...
                    prctile_rank_thick_4])
...
for f3_subs =  1
    ...
    for ST15_ST18 = 1
        ...
        for key_descriptives = 1
            for k = 1:12
                ...
                for i = 1:5
                 ...
                 for i = 1:5
                    x = mean(Xn(keep(keep_affect_exclT3),maps_ns(:,i)>0),2);
                    meansdata(k,5,i) = mean(x);
                    stddata(k,5,i) = std(x);
                    SEM = std(x)/sqrt(length(x)); % Standard Error
                    ts = tinv([0.025  0.975],length(x)-1);      % T-Score
                    cidata = mean(x) + ts*SEM;
                    cidatamin(k,5,i) = cidata(1);
                    cidatamax(k,5,i) = cidata(2);
                end

            end
        end
        
         csvwrite([RPATH 'ST15ctrl.csv'], [...
        ...
        csvwrite([RPATH 'ST17aff.csv'], [...
         ...
         csvwrite([RPATH 'ST17aff_exclTC3.csv'], [...
            meansdata(:,5,1), stddata(:,5,1),cidatamin(:,5,1),cidatamax(:,5,1),...
            meansdata(:,5,2), stddata(:,5,2),cidatamin(:,5,2),cidatamax(:,5,2),...
            meansdata(:,5,3), stddata(:,5,3),cidatamin(:,5,3),cidatamax(:,5,3),...
            meansdata(:,5,4), stddata(:,5,4),cidatamin(:,5,4),cidatamax(:,5,4),...
            meansdata(:,5,5), stddata(:,5,5),cidatamin(:,5,5),cidatamax(:,5,5)])
     
        csvwrite([RPATH 'ST18pers.csv'], [...
    ...
    for ST19_ST21 = 1
        ...
        for i = 1:5
            for k=1:12
                ...
                p_dept(k,1,i)  = 2*(1 - tcdf(abs(slm.t),slm.df));
                t_dept(k,1,i) = slm.t;
                d_dept(k,1,i) = (2*(slm.t))./sqrt(slm.df)
                Xx =  squeeze(mean(layer_400_last(:,k,:),2));
                slm      = SurfStatLinMod(mean(Xx(keep,maps_ns(:,i)>0),2),M);
                slm      = SurfStatT(slm,(GN.Presence-GN.Affect));
                slm2 = slm.t;
                p_dept(k,2,i)  = 2*(1 - tcdf(abs(slm.t),slm.df));
                t_dept(k,2,i) = slm.t;
                d_dept(k,2,i) = (2*(slm.t))./sqrt(slm.df)
                Xx =  squeeze(mean(layer_400_last(:,k,:),2));
                slm      = SurfStatLinMod(mean(Xx(keep,maps_ns(:,i)>0),2),M);
                slm      = SurfStatT(slm,(GN.Perspective-GN.Affect));
                slm2 = slm.t;
                p_dept(k,3,i)  = 2*(1 - tcdf(abs(slm.t),slm.df));
                t_dept(k,3,i) = slm.t;
                d_dept(k,3,i) = (2*(slm.t))./sqrt(slm.df)

            end
        end
        
        % presence vs perspective
        csvwrite([RPATH 'ST19.csv'], [...
                t_dept(:,1,1), p_dept(:,1,1), d_dept(:,1,1),...
                t_dept(:,1,2), p_dept(:,1,2), d_dept(:,1,2),...
                t_dept(:,1,3), p_dept(:,1,3), d_dept(:,1,3),...
                t_dept(:,1,4), p_dept(:,1,4), d_dept(:,1,4),...
                t_dept(:,1,5), p_dept(:,1,5), d_dept(:,1,5)])
            
        csvwrite([RPATH 'ST20.csv'], [...
                t_dept(:,2,1), p_dept(:,2,1), d_dept(:,2,1),...
                t_dept(:,2,2), p_dept(:,2,2), d_dept(:,2,2),...
                t_dept(:,2,3), p_dept(:,2,3), d_dept(:,2,3),...
                t_dept(:,2,4), p_dept(:,2,4), d_dept(:,2,4),...
                t_dept(:,2,5), p_dept(:,2,5), d_dept(:,2,5)])
            
        csvwrite([RPATH 'ST21.csv'], [...
                t_dept(:,3,1), p_dept(:,3,1), d_dept(:,3,1),...
                t_dept(:,3,2), p_dept(:,3,2), d_dept(:,3,2),...
                t_dept(:,3,3), p_dept(:,3,3), d_dept(:,3,3),...
                t_dept(:,3,4), p_dept(:,3,4), d_dept(:,3,4),...
                t_dept(:,3,5), p_dept(:,3,5), d_dept(:,3,5)])
    ...
    for ST28_ST32 = 1
        ...
        for i = 1:5
            for k=1:12
                ...
                slm      = SurfStatT(slm,(G4.Group_1-G4.Group3));
                slm2 = slm.t;
                p_dept(k,4,i)  = 2*(1 - tcdf(abs(slm.t),slm.df));
                t_dept(k,4,i) = slm.t;
                Xx =  squeeze(mean(layer_400_last(:,k,:),2));
                slm      = SurfStatLinMod(mean(Xx(keep,maps_ns(:,i)>0),2),M);
                slm      = SurfStatT(slm,(G4.Group_2-G4.Group3));
                slm2 = slm.t;
                p_dept(k,5,i)  = 2*(1 - tcdf(abs(slm.t),slm.df));
                t_dept(k,5,i) = slm.t;
            end
        end
        
        csvwrite([RPATH 'ST28.csv'], [...
            t_dept(:,1,1), p_dept(:,1,1),...
            t_dept(:,1,2), p_dept(:,1,2),...
            t_dept(:,1,3), p_dept(:,1,3),...
            t_dept(:,1,4), p_dept(:,1,4),...
        ...
        csvwrite([RPATH 'ST31.csv'], [...
            t_dept(:,4,1), p_dept(:,4,1),...
            t_dept(:,4,2), p_dept(:,4,2),...
            t_dept(:,4,3), p_dept(:,4,3),...
            t_dept(:,4,4), p_dept(:,4,4),...
            t_dept(:,4,5), p_dept(:,4,5)])
        
        csvwrite([RPATH 'ST32.csv'], [...
            t_dept(:,5,1), p_dept(:,5,1),...
            t_dept(:,5,2), p_dept(:,5,2),...
            t_dept(:,5,3), p_dept(:,5,3),...
            t_dept(:,5,4), p_dept(:,5,4),...
            t_dept(:,5,5), p_dept(:,5,5)]);
    ...
    for ST39_ST40 = 1
        ...
        for i  = 1:12
            ...
            for j = 1:5
                ...
                t_dept(i,2,j) = slm.t;
                p_dept(i,2,j) = 2*(1 - tcdf(abs(slm.t),slm.df));
            end
        end
        
        fdr_bh(p_dept)
        csvwrite([RPATH 'ST39.csv'], [...
            t_dept(:,1,1), p_dept(:,1,1),...
            t_dept(:,1,2), p_dept(:,1,2),...
            t_dept(:,1,3), p_dept(:,1,3),...
            t_dept(:,1,4), p_dept(:,1,4),...
    ...
    for SF5_SF6 = 1
        ...
        for j  = 1:4:12
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5_presence.layer', num2str(j) ,'.fdr.png'],'png', 10)
            close(f)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5_presence.layer', num2str(j) ,'.t.png'],'png', 10)
            close(f)
        end
        ...
        for j  = 1:4:12
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5.perspective.layer', num2str(j) ,'.fdr.png'],'png', 10)
            close(f)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5.perspective.layer', num2str(j) ,'.t.png'],'png', 10)
            close(f)
        ...
        for j  = 1:4:12
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5.affect.layer', num2str(j) ,'.fdr.png'],'png', 10)
            close(f)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5.affect.layer', num2str(j) ,'.t.png'],'png', 10)
            close(f)
        ...
        for j  = 1:4:12
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5.control.layer', num2str(j) ,'.fdr.png'],'png', 10)
            close(f)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5.control.layer', num2str(j) ,'.t.png'],'png', 10)
            close(f)
        ...
        for j  = 1:4:12
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5.pa.layer', num2str(j) ,'.fdr.png'],'png', 10)
            close(f)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5.pa.layer', num2str(j) ,'.t.png'],'png', 10)
            close(f)
        ...
        for j  = 1:4:12
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5.pra.layer', num2str(j) ,'.fdr.png'],'png', 10)
            close(f)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5.pra.layer', num2str(j) ,'.t.png'],'png', 10)
            close(f)
        ...
        for j  = 1:4:12
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5.prp.layer', num2str(j) ,'.fdr.png'],'png', 10)
            close(f)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF5.prp.layer', num2str(j) ,'.t.png'],'png', 10)
            close(f)
        ...
        for k = 1:5
            for lay = 1:4:12
                for run_plot =1
                    xxx      = squeeze(mean(MPC_layers(:,lay:(lay+3),:),2));
                    bh = mean(xxx(:,maps_ns(:,k)>0),2);
                    keep = find(keeptmp>0);
                    Ck = bh;
                    gk = group4(keep);
                    ik = id(keep);
                ...
                exportfigbo(f,[RPATH 'SF6.plot_layerlevel', num2str(k) ,'network', num2str(lay) ,'.png'],'png', 10)
                close(f)
            end
        end
    end
    ...
    for SF7 =1 
      ...
      for j  = 1:4:12
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF7.G1-control.layer', num2str(j) ,'.fdr.png'],'png', 10)
            close(f)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF7.G1-control.layer', num2str(j) ,'.trend.png'],'png', 10)
            close(f)
      ...
      for j  = 1:4:12
          ...
          BoSurfStatColLim([-4 4])
          colormap(flipud(cbrewer('div','RdBu',11)))
          exportfigbo(f,[RPATH 'SF7.G2-control.layer', num2str(j) ,'.fdr.png'],'png', 10)
          close(f)
          ...
          BoSurfStatColLim([-4 4])
          colormap(flipud(cbrewer('div','RdBu',11)))
          exportfigbo(f,[RPATH 'SF7.G2-control.layer', num2str(j) ,'.trend.png'],'png', 10)
          close(f)
      ...
      for j  = 1:4:12
          ...
          BoSurfStatColLim([-4 4])
          colormap(flipud(cbrewer('div','RdBu',11)))
          exportfigbo(f,[RPATH 'SF7.G3-control.layer', num2str(j) ,'.fdr.png'],'png', 10)
          close(f)
          ...
          BoSurfStatColLim([-4 4])
          colormap(flipud(cbrewer('div','RdBu',11)))
          exportfigbo(f,[RPATH 'SF7.G3-control.layer', num2str(j) ,'.trend.png'],'png', 10)
          close(f)
      ...
      for j  = 1:4:12
          ...
          BoSurfStatColLim([-4 4])
          colormap(flipud(cbrewer('div','RdBu',11)))
          exportfigbo(f,[RPATH 'SF7.G1-G3.layer', num2str(j) ,'.fdr.png'],'png', 10)
          close(f)
          ...
          BoSurfStatColLim([-4 4])
          colormap(flipud(cbrewer('div','RdBu',11)))
          exportfigbo(f,[RPATH 'SF7.G1-G3.layer', num2str(j) ,'.trend.png'],'png', 10)
          close(f)
      ...
      for j  = 1:4:12
          ...
          BoSurfStatColLim([-4 4])
          colormap(flipud(cbrewer('div','RdBu',11)))
          exportfigbo(f,[RPATH 'SF7.G2-G3.layer', num2str(j) ,'.fdr.png'],'png', 10)
          close(f)
          ...
          BoSurfStatColLim([-4 4])
          colormap(flipud(cbrewer('div','RdBu',11)))
          exportfigbo(f,[RPATH 'SF7.G2-G3.layer', num2str(j) ,'.trend.png'],'png', 10)
          close(f)
      ...
      for  i = 1:5
            for human_profile = 1
                f=figure,
                ax = axes;
                ax.ColorOrder = [0.9844,    0.8828,    0.0195; 0.9844,    0.8828,    0.5195; 0.9412,    0.2314,    0.1255; ...
                    0.8275    0.8902    0.9529];
                hold on
                keep_presence = (find(strcmp(group4(keep),'Group_1')))
                keep_presence2 = (find(strcmp(group4(keep),'Group_2')))
                keep_affect = (find(strcmp(groupN(keep),'Affect')))
                keep_control1 = intersect(find(strcmp(groupN(keep),'Control1')),find(strcmp(tp(keep),'T1')))
                
                plot(mean(mean(squeeze(layer_400_last(keep(keep_presence),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
                hold on
                plot(mean(mean(squeeze(layer_400_last(keep(keep_presence2),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
                hold on
                plot(mean(mean(squeeze(layer_400_last(keep(keep_affect),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
                hold on
                plot(mean(mean(squeeze(layer_400_last(keep(keep_control1),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
                exportfigbo(f,[RPATH 'SF7.T0T1.network',num2str(i),'.layerz.png'],'png', 10)
            end
        end
    end 
    ...
    for  i = 1:5
        for human_profile = 1
           f=figure,
           ax = axes;
           ax.ColorOrder = [0.8275    0.8902    0.9529; 0.4196    0.6824    0.8392; 0.0314    0.3176    0.6118];
           hold on
           keep_control1 = intersect(find(strcmp(groupN(keep),'Control1')),find(strcmp(tp(keep),'T1')))
           keep_control2 = intersect(find(strcmp(groupN(keep),'Control1')),find(strcmp(tp(keep),'T2')))
           keep_control3 = intersect(find(strcmp(groupN(keep),'Control1')),find(strcmp(tp(keep),'T3')))
           plot(mean(mean(squeeze(layer_400_last(keep(keep_control1),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
           hold on
           plot(mean(mean(squeeze(layer_400_last(keep(keep_control2),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
           hold on
           plot(mean(mean(squeeze(layer_400_last(keep(keep_control3),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
           exportfigbo(f,[RPATH 'SF7.controls.network',num2str(i),'.layerz.png'],'png', 10)
        end
    end  
      ...
      for  i =1:5
        for human_profile = 1
            f=figure,
            ax = axes;
            ax.ColorOrder = [0.9961    0.7686    0.3098; 0.9844,    0.8828,    0.0195;...
                0.4549    0.7686    0.4627; 0.1922,    0.6392,    0.3294; ...
                0.9882    0.5725    0.44710; 0.9412,    0.2314,    0.1255; 0.9412,    0.5314,    0.1255;...
                0.6196    0.7922    0.8824];
            hold on
            keep_presence1 = intersect(find(strcmp(groupN(keep),'Presence')),find(strcmp(group4(keep),'Group_1')))
            keep_presence2 = intersect(find(strcmp(groupN(keep),'Presence')),find(strcmp(group4(keep),'Group_2')))
            keep_perspective1 = intersect(find(strcmp(groupN(keep),'Perspective')),find(strcmp(group4(keep),'Group_1')))
            keep_perspective2 = intersect(find(strcmp(groupN(keep),'Perspective')),find(strcmp(group4(keep),'Group_2')))
            keep_affect1 = intersect(find(strcmp(groupN(keep),'Affect')),find(strcmp(group4(keep),'Group_1')))
            keep_affect2 = intersect(find(strcmp(groupN(keep),'Affect')),find(strcmp(group4(keep),'Group_2')))
            keep_affect3 = intersect(find(strcmp(groupN(keep),'Affect')),find(strcmp(group4(keep),'Group3')))
            keep_control = (find(strcmp(groupN(keep),'Control1')))
            
            plot(mean(mean(squeeze(layer_400_last(keep(keep_presence1),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
            hold on
            plot(mean(mean(squeeze(layer_400_last(keep(keep_presence2),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
            hold on
            plot(mean(mean(squeeze(layer_400_last(keep(keep_perspective1),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
            hold on
            plot(mean(mean(squeeze(layer_400_last(keep(keep_perspective2),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
            hold on
            plot(mean(mean(squeeze(layer_400_last(keep(keep_affect1),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
            hold on
            plot(mean(mean(squeeze(layer_400_last(keep(keep_affect2),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
            hold on
            plot(mean(mean(squeeze(layer_400_last(keep(keep_affect3),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
            hold on
            plot(mean(mean(squeeze(layer_400_last(keep(keep_control),:,maps_ns(:,i)>0))),3),1:12,'LineWidth',10)
            exportfigbo(f,[RPATH 'SF7.allgrous.network.',num2str(i),'.png'],'png', 10)
        end
        end
end
    ...
    for SF8 = 1
        ...
        for j  = 1:4:12
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF8.training_control.layer', num2str(j) ,'.fdr.png'],'png', 10)
            close(f)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF8.training_control.layer', num2str(j) ,'.trend.png'],'png', 10)
            close(f)
        end
        ...
        for j  = 1:4:12
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF8.control.layer', num2str(j) ,'.fdr.png'],'png', 10)
            close(f)
            ...
            BoSurfStatColLim([-4 4])
            colormap(flipud(cbrewer('div','RdBu',11)))
            exportfigbo(f,[RPATH 'SF8.control.layer', num2str(j) ,'.p.png'],'png', 10)
            close(f)
        end
...
for f4 = 1
    for make_attention = 1
        ...
        keep    = mintersect(keep1,keep2,keep2b,keep5,keep6);
